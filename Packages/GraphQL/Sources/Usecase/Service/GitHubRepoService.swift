...
public protocol GitHubRepoService {
    func listGitHubRepo(input: GitHubSearchFilterInput) -> AnyPublisher<GitHubRepoConnection, GraphQLError>
}
...
public struct GitHubRepoServiceImpl: GitHubRepoService {
    ...
    public func listGitHubRepo(input: GitHubSearchFilterInput) -> AnyPublisher<GitHubRepoConnection, GraphQLError> {
